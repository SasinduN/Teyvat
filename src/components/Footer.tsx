      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12 pb-16 border-b border-white/10">
          ...
          <div className="md:col-span-4 space-y-5">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a href="#instagram" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#D4AF37] hover:text-[#0F2E23] flex items-center justify-center transition-colors" aria-label="Instagram">
              ...
              <a href="#facebook" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#D4AF37] hover:text-[#0F2E23] flex items-center justify-center transition-colors" aria-label="Facebook">
              ...
              <a href="#tiktok" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#D4AF37] hover:text-[#0F2E23] flex items-center justify-center transition-colors font-bold text-xs" aria-label="TikTok">
                TT
              </a>
              <a href="#youtube" className="w-9 h-9 rounded-full bg-white/10 hover:bg-[#D4AF37] hover:text-[#0F2E23] flex items-center justify-center transition-colors" aria-label="YouTube">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-3 text-xs text-white/80">
              <li className="flex items-start space-x-3">
                ...
                <span>Level 12, Galle Face Terrace, Colombo 03, Sri Lanka</span>
              </li>
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:hello@traveleye.lk" className="hover:text-[#D4AF37] transition-colors">
                  hello@traveleye.lk
                </a>
              </li>
            </ul>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-white/50 space-y-2 sm:space-y-0">
          ...
          <div className="flex space-x-6">
            ...
            <a href="#sustainability" className="hover:text-white transition-colors">Sustainability Pledge</a>
          </div>
        </div>
